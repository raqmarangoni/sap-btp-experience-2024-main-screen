		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "BTP Experience-Main Screen",
									"targetURL": "#comlab2devbtpexperiencemainscreen-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlab2devbtpexperiencemainscreen-display": {
								"semanticObject": "comlab2devbtpexperiencemainscreen",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lab2dev.btpexperiencemainscreen",
									"url": sap.ui.require.toUrl("com/lab2dev/btpexperiencemainscreen")
								}
							}
						}
					}
